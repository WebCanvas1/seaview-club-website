  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
      ...
      <main id="top">
        ...
        <section className="relative overflow-hidden bg-navy py-24 text-white lg:py-32"><img src={hallImage} alt="Seaview Club dance floor ready for a celebration" className="absolute inset-0 h-full w-full object-cover opacity-25" /><div className="absolute inset-0 bg-navy/80" /><div className="relative mx-auto max-w-7xl px-5 text-center lg:px-8"><p className="eyebrow text-sand">Your next occasion starts here</p><h2 className="mx-auto mt-5 max-w-3xl font-display text-5xl leading-none md:text-7xl">Planning your next function?</h2><p className="mx-auto mt-5 max-w-md text-white/85">Discover one of Lovely Banks' hidden gems.</p><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><button onClick={() => scrollTo('availability')} className="button button-sand">Check available dates <ArrowRight size={16} /></button><button onClick={() => scrollTo('enquire')} className="button button-outline">Enquire now</button></div></div></section>
      </main>
